const RatingStars = (props: {ratingPercent: string}) : JSX.Element => {

    return (<svg xmlns='http://www.w3.org/2000/svg' viewBox="0 0 120 24" >
    <symbol id="star">
    ...
    <rect x="0" y="0" width={props.ratingPercent} height="100%" fill="orange" mask="url(#stars)" />
  </svg>);
}
